...
# static fields
.field private static zznux:Lcom/google/firebase/iid/zzaa;


# instance fields
.field private final zznuy:Landroid/support/v4/util/SimpleArrayMap;
...
.field private zznuz:Ljava/lang/Boolean;

.field final zznva:Ljava/util/Queue;
...
.field private zznvb:Ljava/util/Queue;
    .annotation build Landroid/support/annotation/VisibleForTesting;
    .end annotation
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzaa;->zznuy:Landroid/support/v4/util/SimpleArrayMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/firebase/iid/zzaa;->zznuz:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzaa;->zznva:Ljava/util/Queue;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzaa;->zznvb:Ljava/util/Queue;
...
.method public static declared-synchronized zzchl()Lcom/google/firebase/iid/zzaa;
    .locals 2

    const-class v1, Lcom/google/firebase/iid/zzaa;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/google/firebase/iid/zzaa;->zznux:Lcom/google/firebase/iid/zzaa;

    if-nez v0, :cond_0

    new-instance v0, Lcom/google/firebase/iid/zzaa;

    invoke-direct {v0}, Lcom/google/firebase/iid/zzaa;-><init>()V

    sput-object v0, Lcom/google/firebase/iid/zzaa;->zznux:Lcom/google/firebase/iid/zzaa;
...
.method private final zzd(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    iget-object v1, p0, Lcom/google/firebase/iid/zzaa;->zznuy:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzaa;->zznuy:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :goto_0
    :try_start_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzaa;->zznuz:Ljava/lang/Boolean;
    ...
    :try_start_3
    iget-object v3, p0, Lcom/google/firebase/iid/zzaa;->zznuy:Landroid/support/v4/util/SimpleArrayMap;
...
.method public final zza(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    :pswitch_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzaa;->zznva:Ljava/util/Queue;
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/firebase/iid/zzaa;->zzd(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    :pswitch_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzaa;->zznvb:Ljava/util/Queue;
...
.method public final zzchm()Landroid/content/Intent;
    .locals 1
