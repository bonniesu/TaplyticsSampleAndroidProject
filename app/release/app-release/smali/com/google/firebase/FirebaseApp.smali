...
.field static final zzick:Ljava/util/Map;
...
.field private static final zzlwf:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private static final zzlwg:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private static final zzlwh:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private static final zzlwi:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private static final zzlwj:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set",
            "<",
...
.field private final zzlwk:Lcom/google/firebase/FirebaseOptions;

.field private final zzlwl:Ljava/util/concurrent/atomic/AtomicBoolean;

.field private final zzlwm:Ljava/util/concurrent/atomic/AtomicBoolean;

.field private final zzlwn:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private final zzlwo:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private final zzlwp:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private zzlwq:Lcom/google/android/gms/internal/zzeui;

.field private zzlwr:Lcom/google/firebase/FirebaseApp$zzc;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->zzlwf:Ljava/util/List;
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->zzlwg:Ljava/util/List;
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->zzlwh:Ljava/util/List;
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->zzlwi:Ljava/util/List;

    invoke-static {}, Ljava/util/Collections;->emptySet()Ljava/util/Set;

    move-result-object v0

    sput-object v0, Lcom/google/firebase/FirebaseApp;->zzlwj:Ljava/util/Set;
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->zzick:Ljava/util/Map;
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/google/firebase/FirebaseOptions;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwl:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwm:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwn:Ljava/util/List;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwo:Ljava/util/List;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwp:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwk:Lcom/google/firebase/FirebaseOptions;

    new-instance v0, Lcom/google/android/gms/internal/zzeug;

    invoke-direct {v0}, Lcom/google/android/gms/internal/zzeug;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwr:Lcom/google/firebase/FirebaseApp$zzc;
...
.method public static getApps(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {p0}, Lcom/google/android/gms/internal/zzeuh;->zzew(Landroid/content/Context;)Lcom/google/android/gms/internal/zzeuh;
    ...
    sget-object v0, Lcom/google/firebase/FirebaseApp;->zzick:Ljava/util/Map;
    ...
    invoke-static {}, Lcom/google/android/gms/internal/zzeuh;->zzchr()Lcom/google/android/gms/internal/zzeuh;

    invoke-static {}, Lcom/google/android/gms/internal/zzeuh;->zzchs()Ljava/util/Set;

    move-result-object v0

    sget-object v3, Lcom/google/firebase/FirebaseApp;->zzick:Ljava/util/Map;
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/zzeuh;->zzra(Ljava/lang/String;)Lcom/google/firebase/FirebaseOptions;
...
.method public static getInstance(Ljava/lang/String;)Lcom/google/firebase/FirebaseApp;
    ...
    :cond_0
    invoke-static {}, Lcom/google/firebase/FirebaseApp;->zzboz()Ljava/util/List;
...
.method public static initializeApp(Landroid/content/Context;Lcom/google/firebase/FirebaseOptions;Ljava/lang/String;)Lcom/google/firebase/FirebaseApp;
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/zzeuh;->zzf(Lcom/google/firebase/FirebaseApp;)V

    const-class v1, Lcom/google/firebase/FirebaseApp;

    sget-object v2, Lcom/google/firebase/FirebaseApp;->zzlwf:Ljava/util/List;

    invoke-direct {v0, v1, v0, v2}, Lcom/google/firebase/FirebaseApp;->zza(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V

    invoke-virtual {v0}, Lcom/google/firebase/FirebaseApp;->zzbox()Z
    ...
    sget-object v2, Lcom/google/firebase/FirebaseApp;->zzlwg:Ljava/util/List;
    ...
    sget-object v3, Lcom/google/firebase/FirebaseApp;->zzlwh:Ljava/util/List;
...
.method static synthetic zza(Lcom/google/firebase/FirebaseApp;)V
    ...
    invoke-direct {p0}, Lcom/google/firebase/FirebaseApp;->zzbpa()V
...
.method private final zza(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V
    ...
    invoke-static {v0}, Lcom/google/firebase/FirebaseApp$zzd;->zzep(Landroid/content/Context;)V
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/FirebaseApp;->zzlwi:Ljava/util/List;
    ...
    sget-object v1, Lcom/google/firebase/FirebaseApp;->zzlwj:Ljava/util/Set;
...
.method public static zzbe(Z)V
    ...
    sget-object v1, Lcom/google/firebase/FirebaseApp;->zzick:Ljava/util/Map;
    ...
    iget-object v5, v1, Lcom/google/firebase/FirebaseApp;->zzlwl:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, p0}, Lcom/google/firebase/FirebaseApp;->zzca(Z)V
...
.method static synthetic zzbfw()Ljava/lang/Object;
    .locals 1
...
.method private final zzbow()V
    .locals 2

    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwm:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private static zzboz()Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private final zzbpa()V
    .locals 3

    const-class v0, Lcom/google/firebase/FirebaseApp;

    sget-object v1, Lcom/google/firebase/FirebaseApp;->zzlwf:Ljava/util/List;

    invoke-direct {p0, v0, p0, v1}, Lcom/google/firebase/FirebaseApp;->zza(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V

    invoke-virtual {p0}, Lcom/google/firebase/FirebaseApp;->zzbox()Z
    ...
    sget-object v1, Lcom/google/firebase/FirebaseApp;->zzlwg:Ljava/util/List;
    ...
    sget-object v2, Lcom/google/firebase/FirebaseApp;->zzlwh:Ljava/util/List;
...
.method private final zzca(Z)V
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwo:Ljava/util/List;
...
.method public getApplicationContext()Landroid/content/Context;
    ...
    invoke-direct {p0}, Lcom/google/firebase/FirebaseApp;->zzbow()V
...
.method public getOptions()Lcom/google/firebase/FirebaseOptions;
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwk:Lcom/google/firebase/FirebaseOptions;
...
.method public final getToken(Z)Lcom/google/android/gms/tasks/Task;
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwq:Lcom/google/android/gms/internal/zzeui;
    ...
    invoke-interface {v0, p1}, Lcom/google/android/gms/internal/zzeui;->zzcb(Z)Lcom/google/android/gms/tasks/Task;
...
.method public final getUid()Ljava/lang/String;
    ...
    invoke-interface {v0}, Lcom/google/android/gms/internal/zzeui;->getUid()Ljava/lang/String;
...
.method public setAutomaticResourceManagementEnabled(Z)V
    ...
    iget-object v3, p0, Lcom/google/firebase/FirebaseApp;->zzlwl:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/api/internal/zzk;->zzagq()Z
    ...
    invoke-direct {p0, v1}, Lcom/google/firebase/FirebaseApp;->zzca(Z)V
    ...
    invoke-direct {p0, v2}, Lcom/google/firebase/FirebaseApp;->zzca(Z)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/firebase/FirebaseApp;->zzlwk:Lcom/google/firebase/FirebaseOptions;
...
.method public final zza(Lcom/google/android/gms/internal/zzeui;)V
    .locals 1
    .param p1    # Lcom/google/android/gms/internal/zzeui;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    ...
    check-cast v0, Lcom/google/android/gms/internal/zzeui;

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwq:Lcom/google/android/gms/internal/zzeui;

    return-void
.end method

.method public final zza(Lcom/google/android/gms/internal/zzeuj;)V
    .locals 5
    .param p1    # Lcom/google/android/gms/internal/zzeuj;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwn:Ljava/util/List;
    ...
    invoke-interface {v0, p1}, Lcom/google/firebase/FirebaseApp$zzb;->zzb(Lcom/google/android/gms/internal/zzeuj;)V
...
.method public final zza(Lcom/google/firebase/FirebaseApp$zza;)V
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzlwl:Ljava/util/concurrent/atomic/AtomicBoolean;
