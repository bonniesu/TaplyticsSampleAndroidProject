...
.field private final zzial:I

.field private final zziam:Z

.field private final zzian:Z

.field private final zziao:Lcom/google/android/gms/gcm/zzi;
...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/Task;->zziai:Ljava/lang/String;
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziaj:Z
    ...
    :goto_1
    iput-boolean v1, p0, Lcom/google/android/gms/gcm/Task;->zziak:Z

    const/4 v0, 0x2

    iput v0, p0, Lcom/google/android/gms/gcm/Task;->zzial:I

    iput-boolean v2, p0, Lcom/google/android/gms/gcm/Task;->zziam:Z

    iput-boolean v2, p0, Lcom/google/android/gms/gcm/Task;->zzian:Z

    sget-object v0, Lcom/google/android/gms/gcm/zzi;->zziad:Lcom/google/android/gms/gcm/zzi;

    iput-object v0, p0, Lcom/google/android/gms/gcm/Task;->zziao:Lcom/google/android/gms/gcm/zzi;
...
.method constructor <init>(Lcom/google/android/gms/gcm/Task$Builder;)V
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziak:Z
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziam:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zzian:Z

    iget-object v0, p1, Lcom/google/android/gms/gcm/Task$Builder;->extras:Landroid/os/Bundle;

    iput-object v0, p0, Lcom/google/android/gms/gcm/Task;->mExtras:Landroid/os/Bundle;

    iget-object v0, p1, Lcom/google/android/gms/gcm/Task$Builder;->zziap:Lcom/google/android/gms/gcm/zzi;
...
.method public static zzv(Landroid/os/Bundle;)V
    .locals 5
...
.method public getRequiredNetwork()I
    ...
    iget v0, p0, Lcom/google/android/gms/gcm/Task;->zzial:I
...
.method public getRequiresCharging()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziam:Z
...
.method public getServiceName()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/gcm/Task;->zziai:Ljava/lang/String;
...
.method public isPersisted()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziak:Z
...
.method public isUpdateCurrent()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziaj:Z
...
.method public toBundle(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Lcom/google/android/gms/gcm/Task;->zziaj:Z

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v0, "persisted"

    iget-boolean v1, p0, Lcom/google/android/gms/gcm/Task;->zziak:Z

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v0, "service"

    iget-object v1, p0, Lcom/google/android/gms/gcm/Task;->zziai:Ljava/lang/String;

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "requiredNetwork"

    iget v1, p0, Lcom/google/android/gms/gcm/Task;->zzial:I

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string v0, "requiresCharging"

    iget-boolean v1, p0, Lcom/google/android/gms/gcm/Task;->zziam:Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/Task;->zziao:Lcom/google/android/gms/gcm/zzi;

    new-instance v2, Landroid/os/Bundle;

    invoke-direct {v2}, Landroid/os/Bundle;-><init>()V

    invoke-virtual {v1, v2}, Lcom/google/android/gms/gcm/zzi;->zzu(Landroid/os/Bundle;)Landroid/os/Bundle;
