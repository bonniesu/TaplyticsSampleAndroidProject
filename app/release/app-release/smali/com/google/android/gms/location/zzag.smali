...
.field private final zzihu:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method constructor <init>(Ljava/util/List;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    :goto_0
    iput-object v0, p0, Lcom/google/android/gms/location/zzag;->zzihu:Ljava/util/List;

    iput-object p2, p0, Lcom/google/android/gms/location/zzag;->zzebp:Landroid/app/PendingIntent;

    iput-object p3, p0, Lcom/google/android/gms/location/zzag;->mTag:Ljava/lang/String;
...
.method public static zzab(Ljava/util/List;)Lcom/google/android/gms/location/zzag;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, v1, v2}, Lcom/google/android/gms/location/zzag;-><init>(Ljava/util/List;Landroid/app/PendingIntent;Ljava/lang/String;)V
...
.method public static zzb(Landroid/app/PendingIntent;)Lcom/google/android/gms/location/zzag;
    .locals 3
    ...
    invoke-direct {v0, v1, p0, v2}, Lcom/google/android/gms/location/zzag;-><init>(Ljava/util/List;Landroid/app/PendingIntent;Ljava/lang/String;)V
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v2, p0, Lcom/google/android/gms/location/zzag;->zzihu:Ljava/util/List;

    invoke-static {p1, v1, v2, v3}, Lcom/google/android/gms/internal/zzbem;->zzb(Landroid/os/Parcel;ILjava/util/List;Z)V

    const/4 v1, 0x2

    iget-object v2, p0, Lcom/google/android/gms/location/zzag;->zzebp:Landroid/app/PendingIntent;

    invoke-static {p1, v1, v2, p2, v3}, Lcom/google/android/gms/internal/zzbem;->zza(Landroid/os/Parcel;ILandroid/os/Parcelable;IZ)V

    const/4 v1, 0x3

    iget-object v2, p0, Lcom/google/android/gms/location/zzag;->mTag:Ljava/lang/String;
