...
.field private zzfwx:I

.field private zzfwy:I

.field zzfwz:Ljava/lang/String;

.field zzfxa:Landroid/os/IBinder;

.field zzfxb:[Lcom/google/android/gms/common/api/Scope;

.field zzfxc:Landroid/os/Bundle;

.field zzfxd:Landroid/accounts/Account;

.field zzfxe:[Lcom/google/android/gms/common/zzc;
...
.method public constructor <init>(I)V
    ...
    iput v0, p0, Lcom/google/android/gms/common/internal/zzz;->zzfwy:I

    iput p1, p0, Lcom/google/android/gms/common/internal/zzz;->zzfwx:I
...
.method constructor <init>(IIILjava/lang/String;Landroid/os/IBinder;[Lcom/google/android/gms/common/api/Scope;Landroid/os/Bundle;Landroid/accounts/Account;[Lcom/google/android/gms/common/zzc;)V
    ...
    iput p2, p0, Lcom/google/android/gms/common/internal/zzz;->zzfwx:I

    iput p3, p0, Lcom/google/android/gms/common/internal/zzz;->zzfwy:I
    ...
    iput-object v1, p0, Lcom/google/android/gms/common/internal/zzz;->zzfwz:Ljava/lang/String;
    ...
    :cond_0
    iput-object v0, p0, Lcom/google/android/gms/common/internal/zzz;->zzfxd:Landroid/accounts/Account;

    :goto_2
    iput-object p6, p0, Lcom/google/android/gms/common/internal/zzz;->zzfxb:[Lcom/google/android/gms/common/api/Scope;

    iput-object p7, p0, Lcom/google/android/gms/common/internal/zzz;->zzfxc:Landroid/os/Bundle;

    iput-object p9, p0, Lcom/google/android/gms/common/internal/zzz;->zzfxe:[Lcom/google/android/gms/common/zzc;

    return-void

    :cond_1
    iput-object p4, p0, Lcom/google/android/gms/common/internal/zzz;->zzfwz:Ljava/lang/String;
    ...
    :cond_4
    iput-object p5, p0, Lcom/google/android/gms/common/internal/zzz;->zzfxa:Landroid/os/IBinder;

    iput-object p8, p0, Lcom/google/android/gms/common/internal/zzz;->zzfxd:Landroid/accounts/Account;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget v2, p0, Lcom/google/android/gms/common/internal/zzz;->zzfwx:I

    invoke-static {p1, v1, v2}, Lcom/google/android/gms/internal/zzbem;->zzc(Landroid/os/Parcel;II)V

    const/4 v1, 0x3

    iget v2, p0, Lcom/google/android/gms/common/internal/zzz;->zzfwy:I

    invoke-static {p1, v1, v2}, Lcom/google/android/gms/internal/zzbem;->zzc(Landroid/os/Parcel;II)V

    const/4 v1, 0x4

    iget-object v2, p0, Lcom/google/android/gms/common/internal/zzz;->zzfwz:Ljava/lang/String;

    invoke-static {p1, v1, v2, v3}, Lcom/google/android/gms/internal/zzbem;->zza(Landroid/os/Parcel;ILjava/lang/String;Z)V

    const/4 v1, 0x5

    iget-object v2, p0, Lcom/google/android/gms/common/internal/zzz;->zzfxa:Landroid/os/IBinder;

    invoke-static {p1, v1, v2, v3}, Lcom/google/android/gms/internal/zzbem;->zza(Landroid/os/Parcel;ILandroid/os/IBinder;Z)V

    const/4 v1, 0x6

    iget-object v2, p0, Lcom/google/android/gms/common/internal/zzz;->zzfxb:[Lcom/google/android/gms/common/api/Scope;

    invoke-static {p1, v1, v2, p2, v3}, Lcom/google/android/gms/internal/zzbem;->zza(Landroid/os/Parcel;I[Landroid/os/Parcelable;IZ)V

    const/4 v1, 0x7

    iget-object v2, p0, Lcom/google/android/gms/common/internal/zzz;->zzfxc:Landroid/os/Bundle;

    invoke-static {p1, v1, v2, v3}, Lcom/google/android/gms/internal/zzbem;->zza(Landroid/os/Parcel;ILandroid/os/Bundle;Z)V

    const/16 v1, 0x8

    iget-object v2, p0, Lcom/google/android/gms/common/internal/zzz;->zzfxd:Landroid/accounts/Account;

    invoke-static {p1, v1, v2, p2, v3}, Lcom/google/android/gms/internal/zzbem;->zza(Landroid/os/Parcel;ILandroid/os/Parcelable;IZ)V

    const/16 v1, 0xa

    iget-object v2, p0, Lcom/google/android/gms/common/internal/zzz;->zzfxe:[Lcom/google/android/gms/common/zzc;
