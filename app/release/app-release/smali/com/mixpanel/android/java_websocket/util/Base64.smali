...
.method public static decode(Ljava/lang/String;I)[B
    ...
    invoke-static {v6, v14, v15, v0}, Lcom/mixpanel/android/java_websocket/util/Base64;->decode([BIII)[B
...
.method public static decode([B)[B
    ...
    invoke-static {p0, v2, v1, v2}, Lcom/mixpanel/android/java_websocket/util/Base64;->decode([BIII)[B
...
.method public static decode([BIII)[B
    ...
    .line 1170
    :cond_4
    invoke-static/range {p3 .. p3}, Lcom/mixpanel/android/java_websocket/util/Base64;->getDecodabet(I)[B
    ...
    invoke-static {v2, v11, v8, v9, v0}, Lcom/mixpanel/android/java_websocket/util/Base64;->decode4to3([BI[BII)I
...
.method public static decodeFromFile(Ljava/lang/String;)[B
    ...
    .line 1486
    .local v0, "bis":Lcom/mixpanel/android/java_websocket/util/Base64$InputStream;
    :try_start_0
    ...
    :goto_1
    :try_start_2
    invoke-virtual {v0}, Lcom/mixpanel/android/java_websocket/util/Base64$InputStream;->close()V
    :try_end_2
    ...
    invoke-direct {v1, v8, v9}, Lcom/mixpanel/android/java_websocket/util/Base64$InputStream;-><init>(Ljava/io/InputStream;I)V
    :try_end_3
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_3} :catch_0
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    .line 1504
    .end local v0    # "bis":Lcom/mixpanel/android/java_websocket/util/Base64$InputStream;
    .local v1, "bis":Lcom/mixpanel/android/java_websocket/util/Base64$InputStream;
    :goto_3
    const/16 v8, 0x1000

    :try_start_4
    invoke-virtual {v1, v2, v6, v8}, Lcom/mixpanel/android/java_websocket/util/Base64$InputStream;->read([BII)I
    ...
    .end local v1    # "bis":Lcom/mixpanel/android/java_websocket/util/Base64$InputStream;
    .end local v2    # "buffer":[B
    .end local v5    # "file":Ljava/io/File;
    .end local v6    # "length":I
    .end local v7    # "numBytes":I
    .restart local v0    # "bis":Lcom/mixpanel/android/java_websocket/util/Base64$InputStream;
    :catch_2
    move-exception v9
    ...
    .end local v0    # "bis":Lcom/mixpanel/android/java_websocket/util/Base64$InputStream;
    .restart local v1    # "bis":Lcom/mixpanel/android/java_websocket/util/Base64$InputStream;
    .restart local v2    # "buffer":[B
    .restart local v5    # "file":Ljava/io/File;
    .restart local v6    # "length":I
    .restart local v7    # "numBytes":I
...
.method public static decodeToFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1448
    .local v0, "bos":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
    :try_start_0
    ...
    invoke-direct {v1, v3, v4}, Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;-><init>(Ljava/io/OutputStream;I)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 1450
    .end local v0    # "bos":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
    .local v1, "bos":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
    :try_start_1
    ...
    invoke-virtual {v1, v3}, Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;->write([B)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_3
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    .line 1452
    .end local v1    # "bos":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
    .restart local v0    # "bos":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
    :catch_0
    move-exception v2
    ...
    :goto_2
    :try_start_4
    invoke-virtual {v0}, Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;->close()V
    :try_end_4
    .catch Ljava/lang/Exception; {:try_start_4 .. :try_end_4} :catch_2
    ...
    .end local v0    # "bos":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
    .restart local v1    # "bos":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
    :catch_1
    move-exception v3
...
.method public static decodeToObject(Ljava/lang/String;ILjava/lang/ClassLoader;)Ljava/lang/Object;
    ...
    :cond_0
    :try_start_4
    new-instance v6, Lcom/mixpanel/android/java_websocket/util/Base64$1;

    invoke-direct {v6, v1, p2}, Lcom/mixpanel/android/java_websocket/util/Base64$1;-><init>(Ljava/io/InputStream;Ljava/lang/ClassLoader;)V
    :try_end_4
...
.method public static encode(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)V
    ...
    .line 567
    invoke-static {v0, v1, v2, v4}, Lcom/mixpanel/android/java_websocket/util/Base64;->encode3to4([B[BII)[B
...
.method public static encode(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)V
    ...
    .line 591
    invoke-static {v0, v2, v3, v5}, Lcom/mixpanel/android/java_websocket/util/Base64;->encode3to4([B[BII)[B
...
.method public static encodeBytes([B)Ljava/lang/String;
    ...
    invoke-static {p0, v2, v3, v4}, Lcom/mixpanel/android/java_websocket/util/Base64;->encodeBytes([BIII)Ljava/lang/String;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static encodeBytes([BII)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p0, p1, p2, v2}, Lcom/mixpanel/android/java_websocket/util/Base64;->encodeBytes([BIII)Ljava/lang/String;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static encodeBytesToBytes([B)[B
    ...
    invoke-static {p0, v2, v3, v4}, Lcom/mixpanel/android/java_websocket/util/Base64;->encodeBytesToBytes([BIII)[B
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static encodeBytesToBytes([BIII)[B
    ...
    .line 918
    .local v10, "b64os":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
    :try_start_0
    ...
    :try_start_1
    new-instance v11, Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;

    or-int/lit8 v4, p3, 0x1

    invoke-direct {v11, v13, v4}, Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;-><init>(Ljava/io/OutputStream;I)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_7
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .line 920
    .end local v10    # "b64os":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
    .local v11, "b64os":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
    :try_start_2
    ...
    :goto_0
    :try_start_5
    invoke-virtual {v11}, Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;->close()V
    :try_end_5
    ...
    .line 991
    .end local v11    # "b64os":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
    ...
    .line 925
    .restart local v10    # "b64os":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
    ...
    :goto_6
    :try_start_9
    invoke-virtual {v10}, Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;->close()V
    :try_end_9
    ...
    invoke-static/range {v4 .. v9}, Lcom/mixpanel/android/java_websocket/util/Base64;->encode3to4([BII[BII)[B
    ...
    .end local v20    # "len2":I
    .end local v21    # "lineLength":I
    .restart local v11    # "b64os":Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;
...
.method public static encodeObject(Ljava/io/Serializable;I)Ljava/lang/String;
    ...
    invoke-direct {v1, v3, v10}, Lcom/mixpanel/android/java_websocket/util/Base64$OutputStream;-><init>(Ljava/io/OutputStream;I)V
    :try_end_1
