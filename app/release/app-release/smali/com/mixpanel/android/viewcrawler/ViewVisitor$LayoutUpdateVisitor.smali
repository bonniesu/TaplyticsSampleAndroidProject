...
.method private verifyLayout(Ljava/util/Set;Landroid/util/SparseArray;)Z
    ...
    .end local v1    # "childLayoutParams":Landroid/widget/RelativeLayout$LayoutParams;
    .end local v2    # "dependencies":Ljava/util/List;, "Ljava/util/List<Landroid/view/View;>;"
    .end local v6    # "layoutRules":[I
    :cond_2
...
.method public accumulate(Landroid/view/View;)V
    ...
    .end local v5    # "currentParams":Landroid/widget/RelativeLayout$LayoutParams;
    .end local v6    # "currentRules":[I
    .end local v9    # "layoutRule":Lcom/mixpanel/android/viewcrawler/ViewVisitor$LayoutRule;
    .end local v11    # "rules":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Integer;>;"
    :cond_4
    return-void

    .line 263
    .restart local v4    # "currentChild":Landroid/view/View;
    .restart local v5    # "currentParams":Landroid/widget/RelativeLayout$LayoutParams;
    .restart local v6    # "currentRules":[I
    .restart local v9    # "layoutRule":Lcom/mixpanel/android/viewcrawler/ViewVisitor$LayoutRule;
    :cond_5
    move-object/from16 v0, p0
...
.method public cleanup()V
    ...
    .line 217
    .end local v0    # "changedView":Landroid/view/View;
    .end local v1    # "i":I
    .end local v2    # "original":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroid/view/View;[I>;"
    .end local v3    # "originalParams":Landroid/widget/RelativeLayout$LayoutParams;
    .end local v4    # "originalValue":[I
    :cond_1
    const/4 v5, 0x0
